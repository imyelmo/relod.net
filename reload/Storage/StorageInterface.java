 ...
 */   
   public void storeDictionary(ResourceId res, NodeId replicaDest, byte replicaNum, KindId kind, Opaque[] data, Opaque[] key, boolean[] exists, long generationCounter) throws Exception{ // M�todo que almacena (con el hilo principal)
